...
-- ----------------------------
-- Table structure for stmf_license_log
-- ----------------------------
DROP TABLE IF EXISTS `stmf_license_log`;
CREATE TABLE `stmf_license_log`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `company_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '公司名称',
  `system_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '被授权系统名称',
  `license` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '许可证书内容',
...
-- ----------------------------
-- Table structure for stmf_manager
-- ----------------------------
DROP TABLE IF EXISTS `stmf_manager`;
CREATE TABLE `stmf_manager`  (
  `id` bigint(0) NOT NULL,
  `manager_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '管理员名称',
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'MD5加盐密码',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL COMMENT '修改时间'
